...
<body>
	<div id="app">
		<div class="container">
			<h1>Vue Todo List</h1>
				<input type="text" v-model="newTodo" class="form-control col-md-4 offset-md-4" @keyup.enter="addTodo" placeholder="Enter your todo">
			<ul>
				<p v-if="!todos.length" class="notodo">No ToDo</p>
